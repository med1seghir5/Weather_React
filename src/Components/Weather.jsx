...
export default function Weather() {
  ...
  return (
    <div className='bg-gradient-to-r from-[#47BBE1] to-[#0093D1] text-[#ffff]'>
      ...
      <div className='p-10'>
        {weatherInfo && (
          <>
            {weatherInfo.wilaya !== 'not found' && (
              <div className='p-4'>
                <div className='flex flex-col items-center space-y-6 '>
                  ...
                  <p className='font-mono font-semibold text-4xl'>{weatherInfo.description}</p>
                </div>
            ...
            {warning && (
              <div className='flex flex-col items-center space-y-3  font-mono font-semibold bg-red-500 rounded-3xl shadow-slate-600 shadow-xl pt-4'>
                <h1 className='text-6xl'>Warning :</h1>
